...
export default function Valentine() {
  ...
  return (
    <>
      <div className="flex items-center justify-center h-screen main-container">
        <button
        ...
        <div>
          <div>
            <div className="image-container w-[200px] mx-auto">
              {theySaidYes ? (
                <img className="w-full h-full" src={cat9} alt="" />
              ) : (
                <img className="w-full h-full" src={cats[noCount - 1]} alt="" />
              )}
            </div>
            {!theySaidYes ? (
              ...
              <h2 className="font-boogaloo text-2xl lg:text-5xl text-center italic text-[#BD1E91]">
                {
                  yesResponses[
                    Math.floor(Math.random() * (yesResponses.length - 1))
                  ]
                }
              </h2>
            )}
          ...
          {(theySaidYes && " ") || (
            <div className="flex items-center gap-4 mx-auto mt-12 w-fit">
              <button
                onClick={() => {
                  launchConfetti();
                  setTheySaidYes(true);
